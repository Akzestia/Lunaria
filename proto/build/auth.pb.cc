...
static ::_pb::Metadata file_level_metadata_auth_2eproto[1];
...
const char* Auth::_InternalParse(
...
const ::google::protobuf::Message::ClassData Auth::_class_data_ = {
    Auth::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* Auth::GetClassData() const {
  return &_class_data_;
}

void Auth::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool Auth::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* Auth::AccessCachedSize() const {
