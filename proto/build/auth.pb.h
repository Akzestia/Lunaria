...
class Auth final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Auth) */ {
 public:
  inline Auth() : Auth(nullptr) {}
  ~Auth() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Auth(::google::protobuf::internal::ConstantInitialized);

  inline Auth(const Auth& from)
      : Auth(nullptr, from) {}
