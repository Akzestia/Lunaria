...
const ::uint32_t
    TableStruct_vpn_5fgraph_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_vpn_5fgraph_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\017vpn_graph.proto\"\027\n\tVpn_graph\022\n\n\002id\030\001 \001"
    "(\005b\006proto3"
};
static ::absl::once_flag descriptor_table_vpn_5fgraph_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_vpn_5fgraph_2eproto = {
    false,
    false,
    50,
      ...
      ClassDataFull _data_ = {
          {
              ...
              PROTOBUF_FIELD_OFFSET(Vpn_graph, _impl_._cached_size_),
              false,
          },
          &Vpn_graph::MergeImpl,
          &Vpn_graph::kDescriptorMethods,
...
const ::_pbi::TcParseTable<0, 1, 0, 0, 2> Vpn_graph::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::Vpn_graph>(),  // to_prefetch
...
void Vpn_graph::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_vpn_5fgraph_2eproto),
         ::std::false_type{});
